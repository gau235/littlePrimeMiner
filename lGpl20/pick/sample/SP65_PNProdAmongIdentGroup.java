 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/searchDataOfSrc.jsp?nameOfClass=SP65_PNProdAmongIdentGroup" >
 *          SP65_PNProdAmongIdentGroup.java</a>
 *
 * @see SP61_CNProdAmongIdentGroup
 */
public abstract class SP65_PNProdAmongIdentGroup {
	...
	public static void main(String[] sAry) throws Throwable {
		...
		Ery<Seq> eryOfSeq = CartesianProdPva.prodAmongGroup(b64IntoB6ForAllVal32, n, true);

		StringBuilder str = CartesianProdPva.toStrByEryOfSeq(eryOfSeq, sAry, " ", Jsp.L);
		O.l("str=");
		O.l(str);

		long ans = CartesianProdPva.prod64OfToPAmongIdentGroup(n, B64IntoB6.selSort(b64IntoB6ForAllVal32));
