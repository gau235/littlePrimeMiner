 ...
 *          <a target="_blank" href="http://c64.tw/w20/o/searchDataOfSrc.jsp?nameOfClass=S3va_B" >S3va_B.java</a>
 * 
 * @see S3va_L
 */
public abstract class S3va_B extends S3va_A {

	private static final Class<S3va_B> CLASS_THIS = S3va_B.class;
	...
	public static StringBuilder script(Condi condi, CharSequence lineWr) {
		...
		for (int iAry = 0; iAry != ary.length;) {
			...
			while (b64IntoB6ForC != 0b0L) {
				...
				retStr.append(O.C42).append(val32).append(O.C33);
				restN = restN - val32;
